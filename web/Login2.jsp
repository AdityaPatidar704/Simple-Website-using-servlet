...
<body class="container-fluid">
    ...
    <form action="" id="login_display">
        <dl class="main bg-light-subtle opacity-75 p-5">
            <dt class="form-text">Computer Code</dt>
            <dl><input type="text" class="form-control"></dl>
            <dt class="form-text">Password</dt>
            <dl><input type="text" class="form-control"></dl>
        </dl>
        <button id="btn1" class="btn btn-primary right"><i class="fa-solid fa-chevron-right"></i></button>
    </form>
</body>
</html>